    ...
    <section className={styles.section}>
      <div className={styles.container}>
        <div className={styles.pricingCard}>
          ...
          <div className={styles.prices}>
            ...
            <p className={styles.julyPrice}>
              Quem entrar em julho: <br/>R$97/mês
            </p>
            <div className={styles.currentPriceBox}>
              <p className={styles.urgency}>Nas próximas 72 horas:</p>
              <h3 className={styles.currentPrice}>R$67<span className={styles.month}>/mês</span></h3>
              <p className={styles.lock}>(Trava esse valor enquanto for membro)</p>
            </div>
          </div>
          ...
          >
            <Lock size={20} /> QUERO FAZER PARTE DO PORTAL BRILHO
          </a>
        ...
        <div className={styles.footer}>
          <p className={styles.urgencyFooter}>Oferta de R$67/mês válida por 72 horas a partir do vídeo de lançamento</p>
